 ...
 * Test configuration:
     ...
     Dev.Board:       EasyPIC PRO v7 - ac:Ethernet
 ...
 * NOTES:
     ...
     - Turn on LEDA and LEDB LEDs on switch SW5.5 and SW5.6. (board specific)
     - Turn on LCD backlight switch (SW4.1) (board specifc)
 */
...
sbit LCD_RS at LATB4_bit;  // for writing to output pin always use latch (PIC18 family)
sbit LCD_EN at LATB5_bit;  // for writing to output pin always use latch (PIC18 family)
sbit LCD_D4 at LATB0_bit;  // for writing to output pin always use latch (PIC18 family)
sbit LCD_D5 at LATB1_bit;  // for writing to output pin always use latch (PIC18 family)
sbit LCD_D6 at LATB2_bit;  // for writing to output pin always use latch (PIC18 family)
sbit LCD_D7 at LATB3_bit;  // for writing to output pin always use latch (PIC18 family)
...
#else
unsigned char ipAddr[4]    = {192, 168,  20, 60} ;  // my ip addr
...
/*
 * it will be faster to use library Ethernet_putConstString routine
...
/*
 * it will be faster to use library Ethernet_putString routine
