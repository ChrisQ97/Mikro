 ...
 * Test configuration:
     ...
     dev.board:       easypic pro v7 -   ac:One_Wire
 ...
 * NOTES:
     - Place DS1820 in proper position and place jumper J3 in the upper position (RB7). (board specific)
     - Turn on Lcd backlight switch SW4.1. (board specific)
     - Be sure to put the power supply jumper J1 in the 5V position.
 */
...
void main() {
  ANCON0 = 0;                                    // Configure PORTE pins as digital
  ANCON1 = 0;                                    // Configure PORTE pins as digital
  ANCON2 = 0;                                    // Configure PORTE pins as digital
  TRISB.B7 = 1;                                  // Configure RE2 pin as input
