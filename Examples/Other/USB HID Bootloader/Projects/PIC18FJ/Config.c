 ...
 *                ac:PIC18FJ_USB_HID_BootLoader_Memory_Layout                 *
 *                                                                            *
 *  Requirements: PIC18FJ specific.                                           *
 *                                                                            *
 *  Migration:    Along with Config.h, this is the only file in this          *
 *                project that might need to be adjusted when migrating.      *
 *                Switching to another MCU within PIC18FJ family              *
 ...
 *                If these are already set properly, your all done :)         *
 *                                                                            *
 ****************************       CHANGE LOG       **************************
...
const enum TMcuType MCU_TYPE = mtPIC18FJ;     // Target MCU family.
...
const unsigned long BOOTLOADER_SIZE   = 7366; // Bootloader (this) code size.
...
void Config() {
  ...
  Delay_10ms(); // Wait for PLL module to stabilize.
