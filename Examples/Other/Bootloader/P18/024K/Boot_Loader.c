...
void main() org 23928 {
    // 48MHz -->  77  - In this mode, TXSTA.BRGH must be 0
    // 20Mhz --> 129
    // 10MHz -->  64           look for asynchronous high speed table
    //  8Mhz -->  51
    //  4Mhz -->  25
    //            |
    //            |
    ...
    Susart_Init(77);                    // Init USART at 9600 (OSC = 48MHz)
    BRGH_bit = 0;                       // Clears TXSTA.BRGH for Asynchronous mode, 8-bit BRG
